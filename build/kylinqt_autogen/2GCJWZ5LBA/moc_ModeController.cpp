...
QT_MOC_LITERAL(3, 28, 7), // "newMode"
QT_MOC_LITERAL(4, 36, 17), // "exguideSrcChanged"
QT_MOC_LITERAL(5, 54, 5), // "exsrc"
QT_MOC_LITERAL(6, 60, 21), // "exguideSettingChanged"
QT_MOC_LITERAL(7, 82, 7) // "setting"

    },
    "ModeController\0modeChanged\0\0newMode\0"
    "exguideSrcChanged\0exsrc\0exguideSettingChanged\0"
    "setting"
};
...
void ModeController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->exguideSrcChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->exguideSettingChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ModeController::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModeController::modeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ModeController::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModeController::exguideSrcChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (ModeController::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModeController::exguideSettingChanged)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void ModeController::modeChanged(int _t1)
{
...
// SIGNAL 1
void ModeController::exguideSrcChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void ModeController::exguideSettingChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
