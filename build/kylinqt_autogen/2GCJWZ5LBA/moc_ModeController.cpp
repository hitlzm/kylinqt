...
QT_MOC_LITERAL(4, 36, 18), // "currentModeChanged"
QT_MOC_LITERAL(5, 55, 14), // "setCurrentMode"
QT_MOC_LITERAL(6, 70, 4), // "mode"
QT_MOC_LITERAL(7, 75, 11) // "currentMode"

    },
    "ModeController\0modeChanged\0\0newMode\0"
    "currentModeChanged\0setCurrentMode\0"
    "mode\0currentMode"
};
...
void ModeController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->currentModeChanged(); break;
        case 2: _t->setCurrentMode((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (ModeController::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModeController::currentModeChanged)) {
                *result = 1;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = _t->currentMode(); break;
        default: break;
        }
...
// SIGNAL 1
void ModeController::currentModeChanged()
{
