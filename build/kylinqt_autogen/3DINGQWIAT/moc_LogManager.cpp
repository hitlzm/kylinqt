...
QT_MOC_LITERAL(1, 11, 17), // "logEntriesChanged"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8), // "clearLog"
QT_MOC_LITERAL(4, 39, 11), // "appendEntry"
QT_MOC_LITERAL(5, 51, 5), // "entry"
QT_MOC_LITERAL(6, 57, 10) // "logEntries"

    },
    "LogManager\0logEntriesChanged\0\0clearLog\0"
    "appendEntry\0entry\0logEntries"
};
...
void LogManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->appendEntry((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LogManager::logEntriesChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QStringList*>(_v) = _t->logEntries(); break;
        default: break;
        }
...
// SIGNAL 0
void LogManager::logEntriesChanged()
{
