...
Rectangle {
        ...
        ColumnLayout { anchors.fill: parent; spacing: 1
            ...
            RowLayout { id: firstRow; spacing: 4
                GroupBox {
                    ...
                    Row { spacing: 30; anchors.centerIn: parent
                        Column { spacing: 6
                            DataLabel {
                                label: "DYT状态:"
                                value: { switch(laserSerial.laserData.dytStatus) {
                                    case 0x00: return "待机"; case 0x01: return "自检中"; case 0x04: return "定轴搜索"
                                    case 0x05: return "矩形搜索"; case 0x06: return "圆形搜索"; case 0x07: return "捕获"
                                    case 0x08: return "稳定跟踪"; case 0x09: return "记忆跟踪"; case 0x0A: return "定轴搜索(位置)"
                                    case 0x0B: return "矩形搜索(位置)"; case 0x0C: return "圆形搜索(位置)"
                            ...
                            DataLabel { label: "故障信息:"; value: laserSerial.laserData.faultInfo1 === 1 ? "无故障" : (laserSerial.laserData.faultInfo1 === 2 ? "有故障" : "NA")
                                valueColor: laserSerial.laserData.faultInfo1 === 1 ? "#1a73e8" : "#d93025" }
                            DataLabel { label: "故障码:"; value: laserSerial.laserData.faultInfo1 === 2 ? "0x" + laserSerial.laserData.faultInfo2.toString(16).toUpperCase() : "NA"
                                valueColor: "#d93025" }
                        }
                    }
                }
                GroupBox {
                    ...
                    Layout.fillWidth: true; Layout.preferredHeight: groupHeight1
                    label: Label { text: parent.title; font.pixelSize: 18; leftPadding: 12; topPadding: 6 }
                    Row { spacing: 40; anchors.centerIn: parent
                        Column { spacing: 6
    ...
    Connections { target: laserSerial
        function onErrorOccurred(msg) { console.log("Laser serial error:", msg) }
        function onConnected() { console.log("Laser serial connected") }
        function onDisconnected() { console.log("Laser serial disconnected") }
    }
}
