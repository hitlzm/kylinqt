...
Item{
    ...
    property real sinAmplitude: 0
    property real sinFrequency: 0
    ...
    ColumnLayout{
        ...
        Repeater {
            ...
            delegate: RowLayout {
                ...
                CusTextField{
                    ...
                    onEditingFinished: {
                        ...
                        if (index === 0) {                            // 三轴控制
                            ...
                            turntableSendData.inner_startangle = Number(text)|| 0
                            // turntableSendData.index = 1;
                        } else if (index === 2) {
                            turntableSendData.middle_startangle = Number(text)|| 0
                            // turntableSendData.index = 2;
                        } else if (index === 3) {
                            turntableSendData.outter_startangle = Number(text)|| 0
                ...
                CusTextField{
                    ...
                    onEditingFinished: {
                        ...
                        if (index === 0) {                            // 三轴控制
                            ...
                            turntableSendData.inner_endangle = Number(text) || 0
                        } else if (index === 2) {
                            turntableSendData.middle_endangle = Number(text) || 0
                        }else if (index === 3) {
                            turntableSendData.outter_endangle = Number(text) || 0
                        }  
                    }
                }
                CusTextField{
                    ...
                    verticalAlignment: TextInput.AlignVCenter
                    onEditingFinished: {
                            turntableSendData.runtime = Number(text) || 0
                    }
                }
                CusButton_Blue {
                id: sendButton
                ...
                text: "正弦运动"
                onClicked: {
                    turntableSendData.sinMove(index,sinAmplitude,sinFrequency)
                }
                }
